...
function rs_custom_wp_footer() {
	?>
	<strong>&copy; <?php echo date( 'Y' ); ?> <?php bloginfo( 'name' ); ?></strong> &ndash; Built by <a href="http://radleysustaire.com/">Radley Sustaire</a>, powered by <a href="http://wordpress.org/">WordPress</a>.
	<?php
}
